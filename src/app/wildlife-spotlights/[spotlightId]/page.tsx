  ...
  return isWide ? (
        ...
        <div className="w-[62.125rem]">
          ...
          <div className="flex flex-row gap-[6.44rem]">
            <div className="w-[34.75rem] flex flex-col">
              ...
              <p className="b3 text-night mb-[3.75rem]" dangerouslySetInnerHTML={{ __html: (spotlight?.description != null && typeof spotlight?.description === 'string') ? spotlight?.description : ""}}/>
    ...
    <div className="bg-ivory min-h-screen">
      ...
      <div className="flex flex-col gap-10 px-[1.12rem] pt-8 pb-10">
        <div className="flex flex-col gap-5">
          <h1 className="text-night">{spotlight?.name}</h1>
          <p className="b3 text-night" dangerouslySetInnerHTML={{ __html: (spotlight?.description != null && typeof spotlight?.description === 'string') ? spotlight?.description : ""}}/>
        </div>
